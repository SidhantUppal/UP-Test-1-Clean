...
const ProgressRing = ({ percentage, size, strokeWidth, color, label, isVisible, delay }: ProgressRingProps) => {
...
export default function ProgressRingWidget({ id, isEditMode, onRemove }: ProgressRingWidgetProps) {
