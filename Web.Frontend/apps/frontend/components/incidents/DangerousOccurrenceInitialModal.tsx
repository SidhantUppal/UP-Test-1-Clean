...
export interface DangerousOccurrenceInitialData {
  reference: string;
...
interface DangerousOccurrenceInitialModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSaveAndContinue: (data: DangerousOccurrenceInitialData & { incidentCaseId: number }) => void;
}

export const DangerousOccurrenceInitialModal: React.FC<DangerousOccurrenceInitialModalProps> = ({
  isOpen,
  onClose,
  onSaveAndContinue
}) => {
  ...
  const [formData, setFormData] = useState<DangerousOccurrenceInitialData>(() => {
  ...
  const handleFieldChange = (field: keyof DangerousOccurrenceInitialData, value: string | number | null) => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }));
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('[DangerousOccurrenceInitialModal] Saving initial incident data:', formData);
      
      // Call the backend service to create initial incident
      const result = await incidentService.createInitialDangerousOccurrenceIncident({
      ...
      console.log('[DangerousOccurrenceInitialModal] Incident created successfully:', result);
      ...
      console.error('[DangerousOccurrenceInitialModal] Error saving incident:', error);
...
export default DangerousOccurrenceInitialModal;