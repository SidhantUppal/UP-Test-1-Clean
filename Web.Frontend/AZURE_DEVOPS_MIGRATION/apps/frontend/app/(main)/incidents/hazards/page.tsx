...
import { Hazard, HazardCategoryType, calculateRiskLevel, getSeverityColor } from '@/types/hazard.types';
...
export default function HazardsPage() {
  ...
  const loadHazards = async () => {
    try {
      ...
      // Map hazards with calculated risk levels and ensure correct types
