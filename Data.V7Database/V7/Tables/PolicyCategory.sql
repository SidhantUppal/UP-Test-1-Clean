CREATE TABLE [V7].[PolicyCategory] (
    ...
    PRIMARY KEY CLUSTERED ([PolicyCategoryID] ASC),
    CONSTRAINT [FK_PolicyCategory_Parent] FOREIGN KEY ([ParentCategoryID]) REFERENCES [V7].[PolicyCategory] ([PolicyCategoryID]),
